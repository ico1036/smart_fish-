    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLM analyzes document content and simulation requirements, extracts reality seeds, and auto-generates ontology structure
          </p>
          ...
          <div v-if="selectedOntologyItem" class="ontology-detail-overlay">
            <div class="detail-header">
               ...
               <button class="close-btn" @click="selectedOntologyItem = null">&times;</button>
            </div>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, documents are chunked and Zep builds the knowledge graph, extracting entities and relations
          </p>
...
const handleEnterEnvSetup = async () => {
  ...
  try {
    ...
    if (res.success && res.data?.simulation_id) {
      router.push({
        name: 'Simulation',
        params: { id: res.data.simulation_id }
      })
    } else {
