...
const handleGoBack = async () => {
  addLog('Preparing to go back, stopping simulation...')
  stopGraphRefresh()
  ...
  router.push({ name: 'Simulation', params: { id: currentSimulationId.value } })
}
  ...
  try {
    ...
    if (simRes.success && simRes.data) {
      ...
      try {
        ...
        addLog(`Config fetch failed, using default: ${minutesPerRound.value}min/round`)
      }
