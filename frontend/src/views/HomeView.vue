<template>
  <div class="home-container">
    <!-- Top Navigation -->
    <nav class="navbar">
      <div class="nav-brand">SMARTFISH</div>
      <div class="nav-links">
        <a href="https://github.com/666ghj/SmartFish" target="_blank" class="github-link">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a single document, <span class="highlight-bold">SmartFish</span> can extract reality seeds and auto-generate a parallel world with up to <span class="highlight-orange">millions of Agents</span>. Inject variables from a god's-eye view and find <span class="highlight-code">"local optima"</span> in complex group interactions.
            </p>
            <p class="slogan-text">
              Let the future rehearse in Agent swarms, let decisions prevail after a hundred battles<span class="blinking-cursor">_</span>
            </p>
          </div>
        ...
        <div class="hero-right">
          ...
          <div class="logo-container">
            <div class="hero-logo-placeholder">SMARTFISH</div>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine standing by. Upload unstructured data to initialize simulation sequence.
          </p>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity relation extraction & persona generation & environment config</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parse prediction needs</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">ReportAgent interacts deeply with post-simulation environment</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Chat with any agent in the simulated world & ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  :disabled="loading"
                ></textarea>
                <div class="model-badge">Engine: SmartFish-V1.0</div>
              </div>
            </div>
...
// Start simulation - store pending data and navigate to Process page
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Navigate to Process page with 'new' project marker
    router.push({
      name: 'Process',
